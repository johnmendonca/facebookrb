...
available in <tt>env['facebook.client']</tt>.
...
The Facebook parameters in the request are stored in <tt>env['facebook.params']</tt> and <tt>env['facebook.client'].fb_params</tt> if the request is valid (http://wiki.developers.facebook.com/index.php/Verifying_The_Signature)
